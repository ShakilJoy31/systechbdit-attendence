// components/employee/EmployeePasswordChange.tsx
"use client";
...
import { useChangeEmployeePasswordMutation } from "@/redux/api/employee/employeeApi";
...
export default function EmployeePasswordChange() {
    ...
    // Fetch employee details to show profile info
    const { data: employeeData, isLoading: isLoadingEmployee } = useGetEmployeeByIdQuery(userId || '', {
        skip: !userId,
    });
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 mt-1">
                                        Secure your employee account with a strong password
                                    </p>
                                </div>
                            </div>
                            ...
                            {!isLoadingEmployee && employee && (
                                <motion.div
                                    ...
                                    className="bg-gradient-to-r from-blue-50/50 to-purple-50/50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-4 border border-blue-200/50 dark:border-blue-800/50"
                                >
                                    <div className="flex items-center gap-4">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="relative px-6 py-3 rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 border border-gray-300/50 dark:border-gray-700/50 backdrop-blur-sm flex items-center gap-2">
                                ...
                                <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
                                    ...
                                    >
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <h4 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Employee Security Tips</h4>
                                        </div>
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                            {[
                                                { tip: "Use a unique password for work accounts", emoji: "💼" },
                                                { tip: "Never share your password with colleagues", emoji: "🤝" },
                                                { tip: "Enable 2-factor authentication", emoji: "🔐" },
                                                { tip: "Update password every 90 days", emoji: "📅" },
                                                { tip: "Use a password manager", emoji: "📱" },
                                                { tip: "Avoid using personal information", emoji: "👤" },
                                            ].map((item, index) => (
                                                <motion.div
                                                    key={index}
                                                    whileHover={{ x: 5 }}
                                    ...
                                    >
                                        <div className="text-center space-y-2">
                                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                                Click the security shield to update your password
                                            </p>
                                        ...
                                        {isDirty && (
                                            ...
                                            >
                                                <div className="flex items-center justify-center gap-2">
                                                    ...
                                                    <span>Ready to update employee security</span>
                                                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                                                </div>
